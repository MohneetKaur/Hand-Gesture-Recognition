...
class DataTransformation:
    ...
    def transforming_training_data(self) -> transforms.Compose:
        try:
            ...
            logging.info("Exited the transforming_training_data method of DataTransformation class")
    ...
    def transforming_testing_data(self) -> transforms.Compose:
        ...
        try:
            ...
            logging.info("Exited the transforming_testing_data of DataTransformation class")
    ...
    def data_loader(self,train_transform: transforms.Compose, test_transform: transforms.Compose) -> Tuple[DataLoader, DataLoader]:
        try:
            logging.info("Entered the data_loader of DataTransformation class")

            train_data: Dataset = ImageFolder(os.path.join(self.data_ingestion_artifact.train_file_path), transform=train_transform)
            test_data: Dataset = ImageFolder(os.path.join(self.data_ingestion_artifact.test_file_path), transform=test_transform)
            ...
            logging.info("Exited the data_loader method of DataTransformation class")
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        try:
            logging.info("Entered the initial data_transformation method of DataTransformation class")

            train_transform: transforms.Compose = self.transforming_training_data()
            test_transform: transforms.Compose = self.transforming_training_data()
